                ...
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    >
                        <p className="text-base sm:text-lg md:text-xl text-white/40 mb-8 leading-relaxed font-light tracking-wide max-w-xl mx-auto px-4">
                            Your all-in-one AI-powered toolkit to brainstorm, analyze, and build your startup faster.
                        </p>
                    </motion.div>
                    ...
                    >
                        <div className="inline-block group relative bg-gradient-to-b from-white/20 to-white/10 
                            ...
                            <button className="rounded-[1.15rem] px-8 py-6 text-lg font-semibold backdrop-blur-md 
